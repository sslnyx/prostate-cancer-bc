...
const GradingAndStaging = () => {
  return (
    <div>
      <section>
        ...
        <div className="max-w-[810px] mx-auto">
          <p>
            ...
            standard terms for grading and staging helps you and your healthcare
            professionals understand the state of their prostate cancer and
            their risk for further progression of the disease and/or metastasis.
          </p>
          ...
          <p>
            ...
            more accurate overall grade, as cancer is rarely equally spread out
            through the gland. The two numbers are then added together to give a
            total ‘Gleason score.’
          </p>

          <p>
            <u>Gleason scores:</u> The order in which a Gleason score is read is
            important. The first number is the more common grade in the sample
            and the second number is the next most common grade. That means that
            - despite both being Gleason 7 - a Gleason 3+4 patient would have a
            less aggressive cancer than a Gleason 4+3 patient and may require
            different courses of treatment. Generally, the higher the Gleason
            score, the more aggressive the cancer.
          </p>

          <p>
            <i>Stage</i> refers to the degree with which the cancer has spread.
            Early stage cancer is confined to the prostate (localized), while
            intermediate cancer has begun to spread beyond the prostate.
            Advanced stage prostate cancer has metastasized and spread into
            other tissues and bones. Very advanced cancer becomes generalized
            throughout the body.
          </p>

          <p>
            TNM (Tumour Node Metastasis) is the most common system used to stage
            prostate cancer in Canada. The ‘T’ refers to the size of the tumour
            in the prostate, the ‘N’ refers to the degree of lymph node
      ...
      >
        <div className="outer-video mb-20">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/ydZnp1tRknE"
        ...
        <ExpendableContent title="Expand To Know About Each Category">
          ...
          <ul>
            ...
            <li>
              Grade 5: the tissue is very different from normal tissue; this is
              the most aggressive grade
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              T1: The prostate seems normal and the tumour was discovered due to
              a high PSA measurement
            </li>
            <li>T2: the tumour is palpable and confined within the prostate</li>
            <li>
              T3: The tumour extends beyond the prostate (affecting the capsul,
              that is, the tissue surrounding the gland, and/or the seminal
              vesicles)
            </li>
            <li>
