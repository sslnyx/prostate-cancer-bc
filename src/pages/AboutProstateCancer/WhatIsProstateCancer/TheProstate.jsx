...
const TheProstate = () => {
  return (
    <>
      <PageTitle p1="The" p2="Prostate" className="title-light" />
      {/* <PostTitle>
      ...
      <div className="container">
        ...
        <TitleAndContent title="Common prostate diseases">
          ...
          <p>
            As a man ages, his prostate generally increases in size -
            essentially constricting the urethra and decreasing urine flow. This
            is a non-cancerous (or benign) disease of the prostate.
          </p>
          ...
          <ExpendableContent>
            ...
            <div className="py-5">
              ...
              <ul className="list-disc pl-6">
                <li>
                  BPH is generally treated by a treatment called a TURP
                  (Transurethral Resection of the Prostate) in which an
                  instrument is inserted through the urethra to the prostate.
                  Some tissue of the enlarged prostate is cut away, effectively
                  re-sectioning the prostate and removing pressure on the
                  urethra, allowing the patient’s urination to return to normal.
                </li>
              </ul>
            </div>
          </ExpendableContent>
