...
const SignsAndSymptoms = () => {
  return (
    <>
      <PageTitle p1="Signs and" p2="Symptoms" className="title-light" />
      {/* <PostTitle>
      ...
      <div className="container">
        <section>
          <div className="max-w-[600px] mx-auto">
            <p>
              ...
              <span className="font-bold">symptomless</span> (asymptomatic)
              disease and can grow for many years without a patient being aware
              of its presence.
            </p>
          </div>
        </section>
        ...
        <TitleAndContent title="Symptoms">
          <div>
            ...
            <ul className="list-disc pl-4">
              <li>
                Changes in urination: increased frequency, reduced flow, a
                feeling of difficulty to empty the bladder, or the presence of
                blood in the urine (these are more often associated with BPH
