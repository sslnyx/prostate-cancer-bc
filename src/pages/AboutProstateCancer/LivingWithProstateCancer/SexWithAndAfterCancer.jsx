    ...
    <div>
      ...
      <section>
        <div className="max-w-[700px] mx-auto">
          <p>
            Treatment often can cause unwanted side effects for sexual activity
            including reduced sex drive, ‘shrinkage,’ impotence or erectile
            dysfunction, and increased anxiety around sexual performance. While
            sexual dysfunction is not a definite side effect of prostate cancer
            treatment, it is a common one and should be considered and discussed
            both with your healthcare provider and your partner when choosing
            your treatment. While sex may look a bit different for you, a
            healthy sexual life is still possible.
          </p>
