...
const MentalHealthAndWellness = () => {
  return (
    <>
      <PageTitle p1="Mental Health" p2="& Wellness" className="title-light" />
        ...
        <section>
          <div className="max-w-[1000px] mx-auto">
            <div className="max-w-[700px] mx-auto">
              <p>
                A prostate cancer diagnosis can be stressful and can often lead
                to anxiety, depression, or other stress-related mental health
                issues. It is important to try to find ways to manage your
                stress before it worsens.
              </p>
            </div>
          ...
          <div className="max-w-[700px] mx-auto">
            <ul className="list-disc pl-4">
              ...
              <li>
                ...
                <Link to="/get-support/peer-support">one on one</Link> chats
                with fellow patients can provide you with emotional support
              </li>
              <li>
                <a
