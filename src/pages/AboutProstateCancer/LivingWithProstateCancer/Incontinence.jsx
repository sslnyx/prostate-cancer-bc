        ...
        <div className="max-w-[1000px] mx-auto">
          <div className="max-w-[700px] mx-auto">
            <p>
              ...
              invasive prostate cancer treatments. It’s caused by the removal or
              weakening of prostate tissue which normally plays an important
              role in a man’s urinary control mechanism. For most men,
              incontinence is temporary; there may be slight dribbling or
          ...
          <div className="max-w-[700px] mx-auto">
            ...
            <ul className="list-disc pl-4">
              <li className="mb-3">
                Kegel exercises for strengthening your urinary sphincter muscles
                -{" "}
