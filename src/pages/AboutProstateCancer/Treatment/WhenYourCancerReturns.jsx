      ...
      <section>
        <div className="max-w-[1000px] mx-auto">
          <div className="max-w-[700px] mx-auto">
            ...
            <p>
              After radiation or surgery, your PSA levels should remain steady,
              low and/or undetectable. After treatment, you should continue to
              have PSA tests every few months or so (depending on the advice of
              your doctor) in case there are any surviving prostate cancer
              cells.
            </p>
                ...
                <AccordionContent idx={1}>
                  <div className="p-11 pt-0">
                    <p>
                      ...
                      other factors such as your age, medical history, and site
                      of recurrence, you and your healthcare team will discuss a
                      follow-up treatment.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      successfully treated with salvage radiation post-surgery.
                    </p>
