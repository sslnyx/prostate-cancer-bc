      ...
      <TitleAndContent title="Active surveillance">
        <div className="max-w-[700px]">
          <p>
            ...
            with your healthcare team. It is for patients with low-risk cancer.
          </p>

          <strong className="underline">Treatment isn’t always needed!</strong>
          ...
          <ExpendableContent>
            <div className="py-3">
              ...
              <p>
                ...
                Low-risk prostate cancer tumours are small and contained to the
                prostate (have not spread). Because the cancer grows slowly,
                most men with low-risk prostate cancer will die with their
          ...
          <ExpendableContent>
            <div className="py-3">
              <p>
                ...
                PSA tests, digital rectal exams (DREs), and sometimes MRIs. You
                may need to repeat your biopsy at the advice of your doctor(s).
              ...
              <ul className="list-disc pl-4">
                ...
                <li>
                  ...
                  <ul>
                    <li className="flex">
                      <span className="pr-2">-</span>
                      The long-term testing and monitoring can be difficult for
                      those at higher risk of anxiety
                    </li>
                  </ul>
                </li>
              </ul>
          ...
          <ExpendableContent>
            <div className="py-3">
              <ul className="list-disc pl-4">
                <li>Active Surveillance Support Group</li>
                <li>If I Were Tom – Active Surveillance</li>
                <li>Choosing Wisely Canada handout</li>
                <li>Active Surveillance videos</li>
              </ul>
            </div>
          </ExpendableContent>
        </div>
      ...
      <TitleAndContent title="Radical prostatectomy">
        <div>
          <p>
            ...
            surrounding tissues, including parts of the bladder and the seminal
            vesicles.
          </p>

          <p>
            It is an appropriate treatment choice for patients with localized
            cancer (confined to the prostate) who are in good overall health and
          ...
          <ExpendableContent>
            <div className="py-3">
              ...
              remove the prostate internally with the help of the video camera.
              This procedure is less invasive than open surgery and therefore,
              usually has a quicker recovery time.
            </div>
          </ExpendableContent>
          ...
          <ExpendableContent>
            <div className="py-3">
              ...
              surgery, allowing the instruments to move like a human hand in the
              body while avoiding the possibility of human errors like slight
              hand tremors.{" "}
            </div>
          </ExpendableContent>
            ...
            <ul className="list-disc pl-4 py-3">
              <li className="mb-3">
                ...
                <ul className="list-[circle] pl-4">
                  <li>
                    With a radical prostatectomy, the whole prostate is removed
                    allowing your doctor to definitively determine whether or
                    not your cancer was confined to your prostate with
                    post-prostatectomy lab testing. It is thus easier to
              ...
              <li>
                ...
                <ul className="list-[circle] pl-4">
                  <li>
                    There is the potential for adverse side effects following a
                  ...
                  <li>
                    Normal surgical complications may occur as with any surgery
                    including:
                    <ul className="">
                      <li>- Blood loss</li>
          ...
          <ExpendableContent>
            <div className="py-3">
              If I Were Tom Return to Work after a Radical Prostatectomy guide
            </div>
          </ExpendableContent>
        </div>
      </TitleAndContent>
      ...
      <TitleAndContent title="Radiation therapy">
        <div>
          <p>
            ...
            cancer cells and disrupting their DNA, thereby killing or shrinking
            the cancer cells.
          </p>
          ...
          <ExpendableContent>
            <ul className="py-3 list-disc pl-4">
              ...
              <li>
                Patients who may still have some prostate cancer left following
                their surgery (also known as salvage radiation)
              </li>
              <li>
          ...
          <ExpendableContent>
            <ul className="py-3 list-disc pl-4">
              ...
              <li>
                Treatments take only a couple of minutes each, but will require
                about 30 separate treatments and many visits to your hospital
              </li>
              <li>
          ...
          <ExpendableContent>
            <ul className="py-3 list-disc pl-4">
              ...
              <li>
                High-dose brachytherapy involves temporarily inserting flexible
                needles into the prostate to deliver a high dose of radiation
                <ul className="list-[circle] pl-4">
                  <li>
          ...
          <ExpendableContent>
            <div className="py-3">
              If I Were Tom Prostate Brachytherapy - Low dose rate or high dose
              rate: what you need to know - Dr. Juanita Crook
            </div>
          </ExpendableContent>
        </div>
      </TitleAndContent>
