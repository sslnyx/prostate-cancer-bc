      ...
      <div className="container">
        ...
        <section>
          ...
          <div className="max-w-[700px] mx-auto">
            ...
            <p>
              ...
              testosterone in your body, which in turn may stop your tumours
              from growing.
            </p>
            ...
            <ExpendableContent>
              ...
              <p>
                ...
                highly recommend that if you have been put on hormone therapy,
                or may be put on hormone therapy, you consider taking this free
                online course:{" "}
                <a href="https://www.lifeonadt.com" target="_blank">
                  www.lifeonadt.com
                </a>
                . Life on ADT is a 1.5 hour online course and workbook that will
                help you and your loved ones manage your side effects and
                maintain a good quality of life while on ADT.
              </p>
        ...
        <section>
          ...
          <div className="max-w-[700px] mx-auto">
            ...
            <ExpendableContent>
              CRPC is usually treated with chemotherapy when hormone therapy is
              no longer working.
